...
def run(case,radius):
    ...
    folder=V5/case/f'conic_trust_realization_{radius}';frame_solvers={};influenced=set();goals={}
    ...
    for attempt in range(3):
        ...
        for arm in sorted({k//7 for k in influenced}):
            start=time.monotonic();q[begin:end],fit=solve(ss,t[begin:end],h[begin:end],q[begin:end],allow[begin:end],dt,arm,pp,trust_radius=radius,max_iterations=1000)
