...
from tools.common_local_linear_feasibility_v5 import solve
...
def run(case):
    ...
    folder=V5/case/'linear_feasibility_v1';frame_solvers={};influenced=set();goals={}
    ...
    for attempt in range(3):
        ...
        for arm in sorted({k//7 for k in influenced}):
            start=time.monotonic();q[begin:end],fit=solve(ss,t[begin:end],h[begin:end],q[begin:end],allow[begin:end],dt,arm,pp,20)
